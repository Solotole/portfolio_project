...
@app_views.route('/recommendations/<id_user>', methods=['GET'],
...
def recommend(id_user):
    """ route-method to recommend for books according to
        ...
        Args:
            id_user: user's id
        Return:
            returns a list of serialized recommeded books
    """
    recommended_books_serialized = []
    # user data object
    ...
    # Converting the recommended books to a serializable format
